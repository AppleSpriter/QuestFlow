...
- **大成功**（自然 20）：额外 +10 XP + 获得一枚职业卷轴
- **成功**：额外 +5 XP
- **失败**：无额外奖励
- 各职业检定技能不同（如 Wizard：奥术/调查/历史/自然）
- 卷轴数量受职业等级影响：1 级大成功固定 1 个卷轴；2 级开始按职业等级百分比概率额外 +1 个，例如 2 级有 2% 概率获得 2 个卷轴
...
- Tailwind CSS
- Framer Motion
- Zustand（persist 中间件，版本迁移 v1→v6）
